 ...
 * @author Sara
 */
public class viewDespesa extends javax.swing.JDialog {

    /**
     * Creates new form FormDespesa
     */
    public viewDespesa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                viewDespesa dialog = new viewDespesa(new javax.swing.JFrame(), true);
