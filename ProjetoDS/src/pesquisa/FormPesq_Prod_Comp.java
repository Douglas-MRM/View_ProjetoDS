 ...
 * @author Sara
 */
public class FormPesq_Prod_Comp extends javax.swing.JDialog {

    private Produto p = new Produto();

    public FormPesq_Prod_Comp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        preencherTabela("");
    }
    ...
    public void preencherTabela(String name) {
        ...
        for (Produto prod : prodList) {
            modelo.addRow(new Object[]{prod.getId_produto(), prod.getName()});
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPesq_Prod_Comp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormPesq_Prod_Comp dialog = new FormPesq_Prod_Comp(new javax.swing.JFrame(), true);
